 ...
 * @see CountryModel
 * @see com.test.model.impl.CountryImpl
 * @see com.test.model.impl.CountryModelImpl
 * @generated
 */
@ImplementationClassName("com.test.model.impl.CountryImpl")
@ProviderType
public interface Country extends CountryModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.test.model.impl.CountryImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
