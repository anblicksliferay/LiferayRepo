 ...
 * @see com.test.service.persistence.impl.CountryPersistenceImpl
 * @generated
 */
@ProviderType
public class CountryUtil {
	...
	*/
	public static Country remove(long countryId)
		throws com.test.exception.NoSuchCountryException {
