...
/**
 * Provides the local service interface for testable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see testableLocalServiceUtil
...
public interface testableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link testableLocalServiceUtil} to access the testable local service. Add custom service methods to {@link com.test.service.impl.testableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public testable addtestable(testable testable);
	...
	*/
	public testable createtestable(int aid);
	...
	*/
	...
	public testable deletetestable(testable testable);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public testable deletetestable(int aid) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public testable fetchtestable(int aid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public testable gettestable(int aid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public testable updatetestable(testable testable);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<testable> gettestables(int start, int end);
