...
public class PDCAPortletKeys {
	...
	public static final String[] TP_BreakDown_HeaderNames = new String[] { };	
	public static final String[] FullYear_HeaderNames = new String[] { };	
	public static final String[] CP_HeaderNames = new String[] { };	
	public static final String[] EM_OL3_HeaderNames = new String[] { };	
	public static final String[] EM_OLAdj_HeaderNames = new String[] { };	
	public static final String[] PR_OL3_HeaderNames = new String[] { };	
	public static final String[] PR_OLAdj_HeaderNames = new String[] { };	
}