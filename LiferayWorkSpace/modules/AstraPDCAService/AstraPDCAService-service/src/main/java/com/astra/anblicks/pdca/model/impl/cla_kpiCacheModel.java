...
public class cla_kpiCacheModel implements CacheModel<cla_kpi>, Externalizable {
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		ol = objectInput.readLong();

		claPoint = objectInput.readLong();

		achivement = objectInput.readLong();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(ol);

		objectOutput.writeLong(claPoint);

		objectOutput.writeLong(achivement);
	}
	...
	public long ytd;
	public long ol;
	public long claPoint;
	public long achivement;
}