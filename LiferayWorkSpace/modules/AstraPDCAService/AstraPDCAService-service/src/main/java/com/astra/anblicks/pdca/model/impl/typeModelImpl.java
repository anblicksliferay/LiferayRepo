...
/**
 * The base model implementation for the type service. Represents a row in the &quot;astra_type&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class typeModelImpl extends BaseModelImpl<type> implements typeModel {
	 ...
	 */
	public static final String TABLE_NAME = "astra_type";
	...
	public static final String TABLE_SQL_CREATE = "create table astra_type (uuid_ VARCHAR(75) null,typeId LONG not null primary key,typeName VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table astra_type";
	public static final String ORDER_BY_JPQL = " ORDER BY type.typeId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY astra_type.typeId ASC";
