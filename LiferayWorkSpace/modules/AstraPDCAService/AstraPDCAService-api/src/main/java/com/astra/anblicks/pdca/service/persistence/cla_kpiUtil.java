...
public class cla_kpiUtil {
	...
	* @throws NoSuchcla_kpiException if a matching cla_kpi could not be found
	*/
	public static cla_kpi findByKpi_Period(long kpiId, long periodId)
		throws com.astra.anblicks.pdca.exception.NoSuchcla_kpiException {
		return getPersistence().findByKpi_Period(kpiId, periodId);
	}
	...
	*/
	public static cla_kpi fetchByKpi_Period(long kpiId, long periodId) {
		return getPersistence().fetchByKpi_Period(kpiId, periodId);
	}
	...
	*/
	public static cla_kpi fetchByKpi_Period(long kpiId, long periodId,
		boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByKpi_Period(kpiId, periodId, retrieveFromCache);
	}
	...
	*/
	public static cla_kpi removeByKpi_Period(long kpiId, long periodId)
		throws com.astra.anblicks.pdca.exception.NoSuchcla_kpiException {
		return getPersistence().removeByKpi_Period(kpiId, periodId);
	}
	...
	* @return the number of matching cla_kpis
	*/
	public static int countByKpi_Period(long kpiId, long periodId) {
		return getPersistence().countByKpi_Period(kpiId, periodId);
	}
